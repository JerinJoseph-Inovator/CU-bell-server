...
BELL_PIN = board.D18  # GPIO18 (Pin 12)
...
bell_pin = digitalio.DigitalInOut(BELL_PIN)
bell_pin.direction = digitalio.Direction.OUTPUT
bell_pin.value = False  # Ensure the bell is off initially
...
def main():
    ...
    try:
        while True:
            ...
            if show_rtc and (current_time - last_input_time > 30):
                update_lcd("Press A for Modes")
